...
public class InsultFour {
    ...
    private ArrayList<String> två = new ArrayList<>();
    private ArrayList<String> tre = new ArrayList<>();

    public InsultFour() {
        
        ett = readFile("src/pkg17teinsultgenerator/word_1.txt");
        två = readFile("src/pkg17teinsultgenerator/word_1.txt");
        tre = readFile("src/pkg17teinsultgenerator/word_1.txt");
